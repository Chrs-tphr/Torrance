/*------------------------------------------------------------------------------------------------------/
| Program : ACA_BLD_REROOF_ASI_AFTER_BUTTON.js
| Event   : ACA_After Button Event
|
...
/-----------------------------------------------------------------------------------------------------*/
try {
	editEstimatedJobValue(3000);
//	if(matches(AInfo["Permit Scope"],"Residential Reroof") && !matches(AInfo["Roofing Squares"],null,"")){
